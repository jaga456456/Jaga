px.import("px:scene.1.js").then( function ready(scene) {
  var root = scene.root;      //parent element
  var appURLs = ["dynamics.js","fonts.js","fancy.js","apng1.js"];//the array of js files

  // var url;
  var basePackageUri = px.getPackageBaseFilePath();

   var url = basePackageUri + "/images/skulls.png";
  ...
  scene.on("onResize", function (e) {
    updateSize(e.w, e.h);                       //getting the properties from the parent (width and height)
  });
