px.import("px:scene.1.js").then(scene=>{
  ...
  "https://px-apps.sys.comcast.net/px_apps/showcase/img/showcase.png",
  "https://px-apps.sys.comcast.net/px_apps/showcase/img/dromaeo.png",
  "https://px-apps.sys.comcast.net/px_apps/showcase/img/fandango.png"
  ];
